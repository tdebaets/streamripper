...
;General
  ...
  ;Name and file
  Name "Streamripper for Windows and Winamp v1.64.0-beta-2"
  OutFile "streamripper-windows-installer-1.64.0-beta-2.exe"

  ;Default installation folder
  ;InstallDir "$PROGRAMFILES\Streamripper-1.64.0-beta-2"
