...
;General
  ...
  ;Name and file
  Name "Streamripper for Windows and Winamp vi.63-beta-5"
  OutFile "streamripper-windows-installer-i.63-beta-5.exe"

  ;Default installation folder
  ;InstallDir "$PROGRAMFILES\Streamripper-i.63-beta-5"
