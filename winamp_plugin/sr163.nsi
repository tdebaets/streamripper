...
;General
  ...
  ;Name and file
  Name "Streamripper for Windows and Winamp v1.64.0-beta-1"
  OutFile "streamripper-windows-installer-1.64.0-beta-1.exe"

  ;Default installation folder
  ;InstallDir "$PROGRAMFILES\Streamripper-1.64.0-beta-1"
