...
;General
  ...
  ;Name and file
  Name "Streamripper for Windows and Winamp v1.63-beta-4"
  OutFile "streamripper-windows-installer-1.63-beta-4.exe"

  ;Default installation folder
  ;InstallDir "$PROGRAMFILES\Streamripper-1.63-beta-4"
