...
;General
  ...
  ;Name and file
  Name "Streamripper for Windows and Winamp v1.63-beta-6"
  OutFile "streamripper-windows-installer-1.63-beta-6.exe"

  ;Default installation folder
  ;InstallDir "$PROGRAMFILES\Streamripper-1.63-beta-6"
