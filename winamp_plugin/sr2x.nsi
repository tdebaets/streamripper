...
Name "Streamripper for Winamp 2.x/5.x v1.61.27"

; The file to write
OutFile "srwa5-1.61.27.exe"
...
!endif
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Streamripper.Plugin" "DisplayName" "Streamripper Plugin 1.61.27 (Remove only)"
