...
Name "Streamripper for Winamp 2.x/5.x v1.63-beta-4"

; The file to write
OutFile "srwa5-1.63-beta-4.exe"
...
!endif
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Streamripper.Plugin" "DisplayName" "Streamripper Plugin 1.63-beta-4 (Remove only)"
