...
Name "Streamripper for Winamp 2.x/5.x v1.62-beta-5"

; The file to write
OutFile "srwa5-1.62-beta-5.exe"
...
!endif
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Streamripper.Plugin" "DisplayName" "Streamripper Plugin 1.62-beta-5 (Remove only)"
