...
Name "Streamripper for Winamp 2.x/5.x v1.63-beta"

; The file to write
OutFile "srwa5-1.63-beta.exe"
...
!endif
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Streamripper.Plugin" "DisplayName" "Streamripper Plugin 1.63-beta (Remove only)"
