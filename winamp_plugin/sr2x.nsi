...
Name "Streamripper for Winamp 2.x/5.x v1.63-beta-1"

; The file to write
OutFile "srwa5-1.63-beta-1.exe"
...
!endif
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Streamripper.Plugin" "DisplayName" "Streamripper Plugin 1.63-beta-1 (Remove only)"
