...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../lib" /I "../mpglib" /I "../xaudio_sdk/include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "SR_WINAMP_EXPORTS" /D "USE_LAYER_2" /D "USE_LAYER_1" /D "HAVE_MPGLIB" /D "NOANALYSIS" /FR /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib ws2_32.lib xaudio.lib comctl32.lib /nologo /dll /debug /machine:I386 /out:"C:\Program Files\Winamp\Plugins\gen_sripper.dll" /pdbtype:sept /libpath:"..\xaudio_sdk\lib\static\mtd"
